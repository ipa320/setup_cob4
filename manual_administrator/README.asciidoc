...
Allow the pc shutdown after press the power button, editing the existing /etc/acpi/events/powerbtn file

----
sudo vi /etc/acpi/events/powerbtn
----

Add # to comment line: #action=/etc/acpi/powerbtn.shand add a new line: action=/sbin/poweroff and restart acpid:
